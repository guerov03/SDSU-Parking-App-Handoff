...
const VARIANT_OPTIONS: ButtonVariant[] = ["primary", "secondary", "outline", "destructive", "google"];
...
export const IconOnly: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Icon-only buttons should include an aria-label for accessibility.",
      },
    },
  },
};
...
export const InteractiveDemo: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: "Comprehensive example showing various button combinations and states.",
      },
    },
  },
};
